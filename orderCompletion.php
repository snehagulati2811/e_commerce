...
<title>E-Coffee Shop - Order Completion</title>
...
<nav class="navbar navbar-inverse"> 
  <div class="container-fluid">
	...
	<br/><br/><br/><br/><center><span style="font-size:35px;"><i style="font-size:90px;color:green;"class="glyphicon glyphicon-ok"></i><br/>
	Thank you for your order.</span><br/><br/>
<p style="font-size:15px;">Your order has been placed and your order #: <?php echo $order_no; ?>, Please note it down for future reference.</p></center><br/><br/><br/><br/><br/><br/><br/><br/><br/>
</div>
</div>
